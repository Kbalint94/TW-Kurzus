...
const config = {
  title: 'Bálint Oldala',
  tagline: 'Tech Writer Kurzus',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://kbalint94.github.io/',
  baseUrl: '/TW-Kurzus/', 

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'kbalint94', // Usually your GitHub org/user name.
  projectName: 'TW-Kurzus', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Bálint Dokumentációs oldala',
        logo: {
          alt: 'My Site Logo',
          src: 'img/logo.svg',
        },
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Kovács Bálint. Docusaurus próba projekt.`,
      },
      prism: {
